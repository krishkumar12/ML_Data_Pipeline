...
API_SECRET_KEY = "QYJmIoBr4kx8oeTkQkkFiSFMOfWYh4elVFvb98ITa0spk8Z0McCMaWXJx44i1kac" #os.getenv('API_SECRET_KEY',None)
...
SCHEMA_REGISTRY_API_KEY = "SGZGTQ5IUBR2K4P5" # os.getenv('SCHEMA_REGISTRY_API_KEY',None)
SCHEMA_REGISTRY_API_SECRET = "q55G7deZUkzOfnkcWYZA+TEKYaU2EHB4Vc4YC9/nr0aI5muum+ghHQsM5jNafZ8E" #os.getenv('SCHEMA_REGISTRY_API_SECRET',None)
